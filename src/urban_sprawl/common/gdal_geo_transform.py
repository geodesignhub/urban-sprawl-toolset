...
class GdalGeoTransform:
    ...
    @staticmethod
    def parse(value: Tuple[float, float, float, float, float, float]) -> 'GdalGeoTransform':
        (position_x, pixel_size_x, rotation_x, position_y, rotation_y, pixel_size_y) = value
        return GdalGeoTransform(position_x, pixel_size_x, rotation_x, position_y, rotation_y, pixel_size_y)
